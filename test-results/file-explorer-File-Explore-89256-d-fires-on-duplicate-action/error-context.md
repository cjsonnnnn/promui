...
- Name: file-explorer.spec.ts >> File Explorer Panel >> Unsaved changes guard >> UC-04 Guard fires on duplicate action
- Location: tests\e2e\file-explorer.spec.ts:468:9
...
- generic:
  ...
  - button "Open Next.js Dev Tools" [ref=e6] [cursor=pointer]:
    - img [ref=e7]
  - alert
  - dialog "Duplicate File" [ref=e11]:
    - generic [ref=e12]:
      - heading "Duplicate File" [level=2] [ref=e13]
      - paragraph [ref=e14]: Create a copy of this file with a new name. Version history will not be copied.
    - textbox "new-filename" [active] [ref=e16]: uc-a-moojeqtn-3hugnd-copy.yaml
    - generic [ref=e17]:
      - button "Cancel" [ref=e18]
      - button "Duplicate" [ref=e19]
